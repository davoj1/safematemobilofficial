...
interface BHPSiteSelectionPageProps {
  onBack?: () => void
  onSiteSelect?: (siteId: string) => void
}

const BHPSiteSelectionPage: React.FC<BHPSiteSelectionPageProps> = ({
  onBack,
  onSiteSelect,
}) => {
  ...
  const filteredSites = bhpSites.filter(site =>
  ...
  const handleSiteSelect = (siteId: string) => {
    ...
    console.log('Selected BHP site:', siteId)
    onSiteSelect?.(siteId)
    // Handle site selection - navigate to next step
  }
...
export default BHPSiteSelectionPage 