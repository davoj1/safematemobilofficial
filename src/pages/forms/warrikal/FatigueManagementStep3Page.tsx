...
interface FatigueManagementStep3PageProps {
  onNext: () => void
  onBack: () => void
  onClose: () => void
}

const FatigueManagementStep3Page: React.FC<FatigueManagementStep3PageProps> = ({
  onNext,
  onBack,
  onClose
}) => {
...
export default FatigueManagementStep3Page