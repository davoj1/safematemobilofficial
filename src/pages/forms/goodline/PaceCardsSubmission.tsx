...
import { Button, Input, Radio, SignaturePadModal, SelectSupervisorModal } from '../../../components/ui'
...
interface PaceCardsSubmissionProps {
  selectedSite?: {
    id: string
    name: string
    location: string
  ...
  onBack: () => void
  onNext: (data: PaceCardsSubmissionData) => void
}

const PaceCardsSubmission: React.FC<PaceCardsSubmissionProps> = ({
  selectedSite,
  onBack,
  onNext,
}) => {
  const [formData, setFormData] = useState<PaceCardsSubmissionData>({
    selectedCompany: 'goodline', // Default to Goodline
    selectedSupervisor: '',
    firstName: '',
    lastName: '',
    signature: ''
  ...
  const supervisors = [
    { id: '1', name: 'John Smith', company: 'Goodline', role: 'Supervisor', avatar: 'JS' },
    { id: '2', name: 'Sarah Johnson', company: 'Goodline', role: 'Supervisor', avatar: 'SJ' },
    { id: '3', name: 'Mike Wilson', company: 'Goodline', role: 'Supervisor', avatar: 'MW' },
    { id: '4', name: 'Lisa Brown', company: 'Goodline', role: 'Supervisor', avatar: 'LB' },
    { id: '5', name: 'David Lee', company: 'Goodline', role: 'Supervisor', avatar: 'DL' }
  ]
  ...
  const handleInputChange = (field: keyof PaceCardsSubmissionData, value: string) => {
...
export default PaceCardsSubmission
