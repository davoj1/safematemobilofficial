...
interface FatigueManagementSuccessPageProps {
  onGoHome: () => void
}

const FatigueManagementSuccessPage: React.FC<FatigueManagementSuccessPageProps> = ({
  onGoHome
}) => {
  return (
        ...
        <div className="flex flex-col items-center text-center px-3 mb-5 w-full">
          <div className="flex flex-col gap-0.5 w-full mb-5">
            <h1 className="text-[#24262d] text-lg font-semibold leading-7">
              Fatigue assessment submitted successfully!
            </h1>
            <p className="text-[#667085] text-base font-normal leading-6">
              Your wellbeing assessment has been completed.
              <br />
              Thanks for prioritizing safety and looking after yourself!
            </p>
          </div>

          {/* View My Rank Link */}
          <button className="text-[#266273] text-base font-semibold leading-6 underline">
            View My Rank
          </button>
        </div>
      </div>
...
export default FatigueManagementSuccessPage