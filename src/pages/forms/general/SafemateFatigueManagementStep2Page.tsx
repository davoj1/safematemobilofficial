...
interface SafemateFatigueManagementStep2PageProps {
  onNext: () => void
  onBack: () => void
  onClose: () => void
}

const SafemateFatigueManagementStep2Page: React.FC<SafemateFatigueManagementStep2PageProps> = ({
  onNext,
  onBack,
  onClose
}) => {
...
export default SafemateFatigueManagementStep2Page
