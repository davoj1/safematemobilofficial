...
interface ReportHazardStep5Data {
...
interface ReportHazardStep5PageProps {
  selectedSite: any;
  onBack: () => void;
  onNext: (data: ReportHazardStep5Data) => void;
}

export default function ReportHazardStep5Page({ 
  selectedSite, 
  onBack, 
  onNext 
}: ReportHazardStep5PageProps) {
  const [formData, setFormData] = useState<ReportHazardStep5Data>({
  ...
  const handleInputChange = (field: keyof ReportHazardStep5Data, value: string) => {
