...
interface SafemateFatigueManagementSuccessPageProps {
  onGoHome: () => void
  onViewRank?: () => void
}

const SafemateFatigueManagementSuccessPage: React.FC<SafemateFatigueManagementSuccessPageProps> = ({
  onGoHome,
  onViewRank
}) => {
  return (
...
export default SafemateFatigueManagementSuccessPage
