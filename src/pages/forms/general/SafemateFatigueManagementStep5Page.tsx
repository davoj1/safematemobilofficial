...
interface SafemateFatigueManagementStep5PageProps {
  onNext: () => void
  onBack: () => void
  onClose: () => void
}

const SafemateFatigueManagementStep5Page: React.FC<SafemateFatigueManagementStep5PageProps> = ({
  onNext,
  onBack,
  onClose
}) => {
...
export default SafemateFatigueManagementStep5Page
