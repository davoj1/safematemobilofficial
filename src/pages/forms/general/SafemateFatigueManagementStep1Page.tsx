...
interface SafemateFatigueManagementStep1PageProps {
  onNext: (sleep24h: string, sleep48h: string) => void
  onBack: () => void
}

const SafemateFatigueManagementStep1Page: React.FC<SafemateFatigueManagementStep1PageProps> = ({
  onNext,
  onBack
}) => {
...
export default SafemateFatigueManagementStep1Page
