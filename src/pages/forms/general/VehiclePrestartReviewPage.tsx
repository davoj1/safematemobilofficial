...
interface VehiclePrestartReviewPageProps {
  ...
  lastName?: string
  signature?: string
  onSubmit: (selectedCompany: string, otherCompany: string, firstName: string, lastName: string, signature: string) => void
  onBack: () => void
}
...
const VehiclePrestartReviewPage: React.FC<VehiclePrestartReviewPageProps> = ({
  ...
  const handleSubmit = () => {
    onSubmit('', currentOtherCompany, currentFirstName, currentLastName, currentSignature)
  }
