...
interface SafemateFatigueManagementStep4PageProps {
  onNext: () => void
  onBack: () => void
  onClose: () => void
}

const SafemateFatigueManagementStep4Page: React.FC<SafemateFatigueManagementStep4PageProps> = ({
  onNext,
  onBack,
  onClose
}) => {
...
export default SafemateFatigueManagementStep4Page
