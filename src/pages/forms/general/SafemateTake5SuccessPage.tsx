...
interface SafemateTake5SuccessPageProps {
  onGoHome: () => void
  onViewRank?: () => void
}

const SafemateTake5SuccessPage: React.FC<SafemateTake5SuccessPageProps> = ({
  onGoHome,
  onViewRank
}) => {
  return (
        ...
        <div className="flex flex-col items-center text-center px-3 mb-5 w-full">
          <div className="flex flex-col gap-0.5 w-full mb-5">
            ...
            <p className="text-[#667085] text-base font-normal leading-6">
              Your Take 5 safety check has been submitted.
              <br />
              Thanks for helping keep yourself and your work mates safe!
            </p>
          </div>
...
export default SafemateTake5SuccessPage
