...
interface SafemateFatigueManagementReviewPageProps {
  onBack: () => void
  onSubmit: () => void
  formData?: {
    sleep24h?: string
...
const SafemateFatigueManagementReviewPage: React.FC<SafemateFatigueManagementReviewPageProps> = ({
  onBack,
  onSubmit,
  formData = {}
}) => {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f8f7f2] overflow-hidden">
      {/* Header */}
      <HeaderWithBack
        title="Fatigue Management Review"
        onBack={onBack}
          ...
          <div className="bg-white rounded-xl border border-[#d0d5dd] p-3 space-y-2.5">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                ...
                <div className="text-[#667085] text-sm">{formData.companyName || 'Your Company'}</div>
              </div>
...
export default SafemateFatigueManagementReviewPage
