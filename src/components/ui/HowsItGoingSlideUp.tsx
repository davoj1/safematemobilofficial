...
interface HowsItGoingSlideUpProps {
  isOpen: boolean
  onClose: () => void
...
const HowsItGoingSlideUp: React.FC<HowsItGoingSlideUpProps> = ({
  isOpen,
  onClose,
  teamMembers,
  onSubmit
    ...
    <div className="fixed inset-0 z-50 flex items-end">
      ...
      <div className="relative bg-white rounded-t-[20px] w-full h-[85vh] flex flex-col pt-12 pb-6 px-4 shadow-xl">        
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#667085] mt-0.5">Select team members to check in with</p>
        </div>
        ...
        <div className="px-5 py-4 border-t border-[#eaecf0] flex gap-3">
          ...
          >
            Ask Team ({selectedMemberIds.length})
          </Button>
        </div>
      </div>
    </div>
...
export default HowsItGoingSlideUp
